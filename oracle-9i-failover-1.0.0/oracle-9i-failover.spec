...
install -m 0775 -o root -g root -d ${RPM_BUILD_ROOT}%{_sysconfdir}/sysconfig

# Directories
install -m 0750 -o root -g root -d ${RPM_BUILD_ROOT}/root
install -m 0750 -o root -g root -d ${RPM_BUILD_ROOT}/root/bin
install -m 0750 -o root -g root -d ${RPM_BUILD_ROOT}/%{_sysconfdir}/sysconfig

# Scripts
install -m 0750 -o root -g root -d root/bin/orafuncs ${RPM_BUILD_ROOT}/root/bin/orafuncs
install -m 0750 -o root -g root -d root/bin/set-primary.sh ${RPM_BUILD_ROOT}/root/bin/
install -m 0750 -o root -g root -d root/bin/set-standby.sh ${RPM_BUILD_ROOT}/root/bin/
install -m 0750 -o root -g root -d %{_sysconfdir}/sysconfig/orafailover ${RPM_BUILD_ROOT}%{_sysconfdir}/sysconfig/
...
/root/bin/set-primary.sh
/root/bin/set-standby.sh

%defattr(0644,root,root)
%{_sysconfdir}/sysconfig/orafailover
