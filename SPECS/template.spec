...
#install -m 0755 -o root -g root -d ${RPM_BUILD_ROOT}/etc
#install -m 0755 -o root -g root -d ${RPM_BUILD_ROOT}/etc/sysconfig
#install -m 0750 -o root -g root -d ${RPM_BUILD_ROOT}/root/bin
#rsync -avr root/* ${RPM_BUILD_ROOT}/root/
#rsync -avr etc/* ${RPM_BUILD_ROOT}/etc/
